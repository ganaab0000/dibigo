...
ALTER TABLE "MEMBER_ROLE_CATEGORY" ADD CONSTRAINT "MEMBER_ROLE_CATEGORY_PK" PRIMARY KEY ( "ID" );
...
COMMENT ON COLUMN "AUTO_LOGIN"."AUTO_LOGIN_MEMBER_ID" IS '카테고리 종류 - 대기/결제 완료/취소/배송완료/환불/교환 등';
CREATE TABLE "MEMBER" (
	"ID" NUMBER NOT NULL,
...
-- TABLE CONSTRAINT
-- FK
ALTER TABLE "PROJECT" ADD CONSTRAINT "FK_MEMBER_TO_PROJECT_1" FOREIGN KEY ( "MEMBER_ID" ) REFERENCES "MEMBER" ( "ID" );
...
ALTER TABLE "COMMUNITY" ADD CONSTRAINT "FK_MEMBER_TO_COMMUNITY_1" FOREIGN KEY ( "MEMBER_ID" ) REFERENCES "MEMBER" ( "MEMBER_ID" );
...
ALTER TABLE "NOTICE" ADD CONSTRAINT "FK_MEMBER_TO_NOTICE_1" FOREIGN KEY ( "MEMBER_ID" ) REFERENCES "MEMBER" ( "ID" );
ALTER TABLE "FOLLOW" ADD CONSTRAINT "FK_MEMBER_TO_FOLLOW_1" FOREIGN KEY ( "FOLLOW" ) REFERENCES "MEMBER" ( "ID" );
ALTER TABLE "FOLLOW" ADD CONSTRAINT "FK_MEMBER_TO_FOLLOW_2" FOREIGN KEY ( "FOLLOWER" ) REFERENCES "MEMBER" ( "ID" );
ALTER TABLE "VOTE" ADD CONSTRAINT "FK_MEMBER_TO_VOTE_1" FOREIGN KEY ( "MEMBER_ID" ) REFERENCES "MEMBER" ( "ID" );
ALTER TABLE "VOTE" ADD CONSTRAINT "FK_PROJECT_TO_VOTE_1" FOREIGN KEY ( "PROJECT_ID" ) REFERENCES "PROJECT" ( "ID" );
ALTER TABLE "FAQ" ADD CONSTRAINT "FK_MEMBER_TO_FAQ_1" FOREIGN KEY ( "MEMBER_ID" ) REFERENCES "MEMBER" ( "ID" );
...
ALTER TABLE "RESERVE" ADD CONSTRAINT "FK_MEMBER_TO_RESERVE_1" FOREIGN KEY ( "MEMBER_ID" ) REFERENCES "MEMBER" ( "ID" );
ALTER TABLE "VISITOR_PER_DAY" ADD CONSTRAINT "FK_MEMBER_TO_VISITOR_PER_DAY_1" FOREIGN KEY ( "MEMBER_ID" ) REFERENCES "MEMBER" ( "ID" );
ALTER TABLE "BLAME" ADD CONSTRAINT "FK_PROJECT_TO_BLAME_1" FOREIGN KEY ( "PROJECT_ID" ) REFERENCES "PROJECT" ( "ID" );
ALTER TABLE "BLAME" ADD CONSTRAINT "FK_MEMBER_TO_BLAME_1" FOREIGN KEY ( "MEMBER_ID" ) REFERENCES "MEMBER" ( "ID" );
ALTER TABLE "BLAME_REPLY" ADD CONSTRAINT "FK_BLAME_TO_BLAME_REPLY_1" FOREIGN KEY ( "BLAME_ID" ) REFERENCES "BLAME" ( "ID" );
ALTER TABLE "BLAME_REPLY" ADD CONSTRAINT "FK_MEMBER_TO_BLAME_REPLY_1" FOREIGN KEY ( "MEMBER_ID" ) REFERENCES "MEMBER" ( "ID" );
ALTER TABLE "AUTO_LOGIN" ADD CONSTRAINT "FK_MEMBER_TO_AUTO_LOGIN_1" FOREIGN KEY ( "MEMBER_ID" ) REFERENCES "MEMBER" ( "ID" );
